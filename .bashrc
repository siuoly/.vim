...
[ -r /home/siuoly/.byobu/prompt ] && . /home/siuoly/.byobu/prompt   #byobu-prompt#

# >>> conda initialize >>>
# !! Contents within this block are managed by 'conda init' !!
__conda_setup="$('/home/siuoly/.miniconda/bin/conda' 'shell.bash' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/home/siuoly/.miniconda/etc/profile.d/conda.sh" ]; then
        . "/home/siuoly/.miniconda/etc/profile.d/conda.sh"
    else
        export PATH="/home/siuoly/.miniconda/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
...
# PS1 prompt command
# from: https://scriptingosx.com/2019/05/show-exit-code-in-your-bash-prompt/
